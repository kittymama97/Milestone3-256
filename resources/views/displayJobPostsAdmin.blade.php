...
for ($x = 0; $x < count($jobs); $x ++) {
    ...
    echo "<td><form action='jobDelete'><input type='hidden' name='ID' value=" . $jobs[$x]['JOB_ID'] . "><input type='submit' value='Delete'></form>  </td>";
    echo "<td><form action='jobEdit'><input type='hidden' name='ID' value=" . $jobs[$x]['JOB_ID'] . "><input type='submit' value='Edit'></form>  </td>";
